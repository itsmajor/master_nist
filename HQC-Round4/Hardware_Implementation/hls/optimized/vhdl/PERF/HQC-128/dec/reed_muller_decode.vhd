...
architecture behav of reed_muller_decode is 
    ...
    signal ret_V_91_fu_386_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ret_V_91_reg_533 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal ret_V_92_fu_405_p2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal ret_V_93_fu_427_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ret_V_88_fu_433_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ret_V_94_fu_445_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ret_V_90_fu_450_p2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    component reed_muller_decodhbi IS
    generic (
        DataWidth : INTEGER;
    ...
    component reed_muller_decodpcA IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    expanded_0_V_U : component reed_muller_decodhbi
    generic map (
        DataWidth => 10,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    expanded_1_V_U : component reed_muller_decodhbi
    generic map (
        DataWidth => 10,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    expanded_2_V_U : component reed_muller_decodhbi
    generic map (
        DataWidth => 10,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    expanded_3_V_U : component reed_muller_decodhbi
    generic map (
        DataWidth => 10,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    expanded_4_V_U : component reed_muller_decodhbi
    generic map (
        DataWidth => 10,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    expanded_5_V_U : component reed_muller_decodhbi
    generic map (
        DataWidth => 10,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    expanded_6_V_U : component reed_muller_decodhbi
    generic map (
        DataWidth => 10,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    expanded_7_V_U : component reed_muller_decodhbi
    generic map (
        DataWidth => 10,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    transform_V_U : component reed_muller_decodpcA
    generic map (
        DataWidth => 10,
        AddressRange => 128,
        AddressWidth => 7)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln153_reg_519 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ret_V_91_reg_533 <= ret_V_91_fu_386_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    cdw_V_address0 <= grp_expand_and_sum_fu_242_src_V_address0;
    cdw_V_ce0 <= grp_expand_and_sum_fu_242_src_V_ce0;
    ...
    icmp_ln895_2_fu_392_p2 <= "1" when (signed(ret_V_91_reg_533) > signed(rhs_V_30_reg_194)) else "0";
    ...
    peak_abs_value_V_fu_456_p2 <= (rhs_V_30_reg_194 xor ret_V_90_fu_450_p2);
    peak_pos_V_fu_439_p2 <= (rhs_V_28_reg_218 xor ret_V_88_fu_433_p2);
    peak_value_V_fu_417_p2 <= (ret_V_fu_411_p2 xor lhs_V_18_reg_206);
    ret_V_88_fu_433_p2 <= (ret_V_93_fu_427_p2 and new_peak_mask_V_fu_397_p3);
    ret_V_90_fu_450_p2 <= (ret_V_94_fu_445_p2 and new_peak_mask_V_fu_397_p3);
    ret_V_91_fu_386_p2 <= (transform_V_q0 xor rhs_V_fu_378_p3);
    ret_V_92_fu_405_p2 <= (reg_283 xor lhs_V_18_reg_206);
    ret_V_93_fu_427_p2 <= (rhs_V_28_reg_218 xor lhs_V_19_fu_423_p1);
    ret_V_94_fu_445_p2 <= (rhs_V_30_reg_194 xor ret_V_91_reg_533);
    ret_V_fu_411_p2 <= (ret_V_92_fu_405_p2 and new_peak_mask_V_fu_397_p3);
    rhs_V_fu_378_p3 <= 
