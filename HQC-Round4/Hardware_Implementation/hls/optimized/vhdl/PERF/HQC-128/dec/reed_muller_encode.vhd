...
architecture behav of reed_muller_encode is 
    ...
    signal i_V_15_fu_253_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal i_V_15_reg_483 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                i_V_15_reg_483 <= i_V_15_fu_253_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    first_word_V_fu_302_p3 <= 
        ...
        ap_const_lv8_0;
    i_V_15_fu_253_p2 <= std_logic_vector(unsigned(t_V_reg_181) + unsigned(ap_const_lv6_1));
