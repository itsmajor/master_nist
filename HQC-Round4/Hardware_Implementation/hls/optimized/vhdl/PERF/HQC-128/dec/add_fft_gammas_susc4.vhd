...
entity add_fft_gammas_susc4_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of add_fft_gammas_susc4_rom is 
...
entity add_fft_gammas_susc4 is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of add_fft_gammas_susc4 is
    component add_fft_gammas_susc4_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    add_fft_gammas_susc4_rom_U :  component add_fft_gammas_susc4_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
