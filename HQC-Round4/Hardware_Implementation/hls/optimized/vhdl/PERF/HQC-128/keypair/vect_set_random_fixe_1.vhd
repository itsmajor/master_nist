...
architecture behav of vect_set_random_fixe_1 is 
    ...
    signal grp_vector_init_fu_95_ap_start : STD_LOGIC;
    signal grp_vector_init_fu_95_ap_done : STD_LOGIC;
    signal grp_vector_init_fu_95_ap_idle : STD_LOGIC;
    signal grp_vector_init_fu_95_ap_ready : STD_LOGIC;
    signal grp_vector_init_fu_95_array_V_address1 : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_vector_init_fu_95_array_V_ce1 : STD_LOGIC;
    signal grp_vector_init_fu_95_array_V_we1 : STD_LOGIC;
    signal grp_vector_init_fu_95_array_V_d1 : STD_LOGIC_VECTOR (7 downto 0);
    signal t_V_reg_84 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal grp_vector_init_fu_95_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_vector_init_fu_95 : component vector_init
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_vector_init_fu_95_ap_start,
        ap_done => grp_vector_init_fu_95_ap_done,
        ap_idle => grp_vector_init_fu_95_ap_idle,
        ap_ready => grp_vector_init_fu_95_ap_ready,
        array_V_address1 => grp_vector_init_fu_95_array_V_address1,
        array_V_ce1 => grp_vector_init_fu_95_array_V_ce1,
        array_V_we1 => grp_vector_init_fu_95_array_V_we1,
        array_V_d1 => grp_vector_init_fu_95_array_V_d1);
    ...
    grp_vector_init_fu_95_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_vector_init_fu_95_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                    grp_vector_init_fu_95_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_vector_init_fu_95_ap_ready = ap_const_logic_1)) then 
                    grp_vector_init_fu_95_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((grp_vector_init_fu_95_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state3, icmp_ln98_fu_101_p2, grp_vector_init_fu_95_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
    ...
    grp_vector_init_fu_95_ap_start <= grp_vector_init_fu_95_ap_start_reg;
    i_V_fu_107_p2 <= std_logic_vector(unsigned(t_V_reg_84) + unsigned(ap_const_lv7_1));
    icmp_ln98_fu_101_p2 <= "1" when (t_V_reg_84 = ap_const_lv7_42) else "0";
    ...
    v_V_address1_assign_proc : process(v_V_addr_reg_170, grp_vector_init_fu_95_array_V_address1, ap_CS_fsm_state6, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            v_V_address1 <= v_V_addr_reg_170;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            v_V_address1 <= grp_vector_init_fu_95_array_V_address1;
        else 
    ...
    v_V_ce1_assign_proc : process(grp_vector_init_fu_95_array_V_ce1, ap_CS_fsm_state6, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            v_V_ce1 <= ap_const_logic_1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            v_V_ce1 <= grp_vector_init_fu_95_array_V_ce1;
        else 
    ...
    v_V_d1_assign_proc : process(ret_V_reg_176, grp_vector_init_fu_95_array_V_d1, ap_CS_fsm_state6, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            v_V_d1 <= ret_V_reg_176;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            v_V_d1 <= grp_vector_init_fu_95_array_V_d1;
        else 
            v_V_d1 <= "XXXXXXXX";
        end if; 
    end process;
    ...
    v_V_we1_assign_proc : process(grp_vector_init_fu_95_array_V_we1, ap_CS_fsm_state6, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            v_V_we1 <= ap_const_logic_1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            v_V_we1 <= grp_vector_init_fu_95_array_V_we1;
        else 
