...
entity hqc_public_key_from_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of hqc_public_key_from_1 is 
    ...
    signal zext_ln1503_fu_142_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln66_fu_161_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal add_ln1503_fu_136_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    add_ln1503_fu_136_p2 <= std_logic_vector(unsigned(ap_const_lv9_A) + unsigned(ap_phi_mux_i_0_phi_fu_109_p4));
    ...
    pk_V_address0 <= zext_ln1503_fu_142_p1(9 - 1 downto 0);
    ...
    s_V_address1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, zext_ln66_fu_161_p1, zext_ln66_1_fu_170_p1, ap_block_pp0_stage1, ap_CS_fsm_state8)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            ...
            s_V_address1 <= zext_ln66_1_fu_170_p1(10 - 1 downto 0);
            ...
            s_V_address1 <= zext_ln66_fu_161_p1(10 - 1 downto 0);
        else 
    ...
    zext_ln1503_fu_142_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1503_fu_136_p2),64));
    zext_ln66_1_fu_170_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(or_ln65_fu_165_p2),64));
    zext_ln66_fu_161_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln_reg_192),64));
