...
architecture behav of expand_and_sum is 
    ...
    signal tmp_43_reg_731 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_44_reg_736 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_45_reg_741 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_46_reg_746 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_47_reg_751 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_48_reg_756 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ret_V_138_mid2_v_v_fu_358_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln879_fu_365_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal add_ln879_fu_369_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal zext_ln215_11_fu_374_p1 : STD_LOGIC_VECTOR (16 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln887_reg_585 = ap_const_lv1_0))) then
                tmp_43_reg_731 <= src_V_q0(2 downto 2);
                tmp_44_reg_736 <= src_V_q0(3 downto 3);
                tmp_45_reg_741 <= src_V_q0(4 downto 4);
                tmp_46_reg_746 <= src_V_q0(5 downto 5);
                tmp_47_reg_751 <= src_V_q0(6 downto 6);
                tmp_48_reg_756 <= src_V_q0(7 downto 7);
    ...
    ret_V_138_mid2_v_v_fu_358_p3 <= (select_ln879_10_reg_612 & ap_const_lv4_0);
    ret_V_fu_377_p2 <= std_logic_vector(unsigned(add_ln879_fu_369_p2) + unsigned(zext_ln215_11_fu_374_p1));
    ...
    zext_ln215_11_fu_374_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln879_8_reg_594),17));
    ...
    zext_ln68_2_fu_484_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_43_reg_731),10));
    zext_ln68_3_fu_500_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_44_reg_736),10));
    zext_ln68_4_fu_516_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_45_reg_741),10));
    zext_ln68_5_fu_532_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_46_reg_746),10));
    zext_ln68_6_fu_548_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_47_reg_751),10));
    zext_ln68_7_fu_564_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_48_reg_756),10));
    zext_ln68_fu_452_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln68_reg_721),10));
    zext_ln879_fu_365_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ret_V_138_mid2_v_v_fu_358_p3),17));
end behav;
