...
architecture behav of seedexpander_mult_ty is 
    ...
    signal ret_V_40_fu_358_p2 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
  ...
  grp_KeccakF1600_StatePer_fu_255_state_V_6_d1       <= state_V_d1_permute;
    ...
    ret_V_40_fu_358_p2 <= std_logic_vector(signed(ap_const_lv5_11) - signed(i_op_assign_reg_220));
    ...
    zext_ln214_fu_364_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ret_V_40_fu_358_p2),64));
