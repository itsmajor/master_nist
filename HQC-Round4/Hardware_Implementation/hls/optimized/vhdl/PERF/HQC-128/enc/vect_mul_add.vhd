...
architecture behav of vect_mul_add is 
    ...
    constant ap_const_lv13_14CD : STD_LOGIC_VECTOR (12 downto 0) := "1010011001101";
    ...
    component vect_mul_add_a2_lhbi IS
    generic (
        DataWidth : INTEGER;
    ...
    component vect_mul_add_res_ibs IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    a2_large_V_U : component vect_mul_add_a2_lhbi
    generic map (
        DataWidth => 256,
        AddressRange => 71,
        AddressWidth => 7)
    ...
    res_mult_V_U : component vect_mul_add_res_ibs
    generic map (
        DataWidth => 256,
        AddressRange => 140,
        AddressWidth => 8)
    ...
    icmp_ln76_fu_470_p2 <= "1" when (ap_phi_mux_indvar_flatten_phi_fu_287_p4 = ap_const_lv13_14CD) else "0";
