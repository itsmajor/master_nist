...
entity reed_solomon_encoDeQ_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 31
...
architecture rtl of reed_solomon_encoDeQ_rom is 
...
entity reed_solomon_encoDeQ is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of reed_solomon_encoDeQ is
    component reed_solomon_encoDeQ_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    reed_solomon_encoDeQ_rom_U :  component reed_solomon_encoDeQ_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
