...
entity crypto_kem_all_fuVhK_ram is 
    generic(
...
architecture rtl of crypto_kem_all_fuVhK_ram is 
...
entity crypto_kem_all_fuVhK is
    generic (
...
architecture arch of crypto_kem_all_fuVhK is
    component crypto_kem_all_fuVhK_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    crypto_kem_all_fuVhK_ram_U :  component crypto_kem_all_fuVhK_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
