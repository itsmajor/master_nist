...
architecture behav of hqc_ciphertext_from_s is 
    ...
    signal i_V_22_fu_228_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal i_V_22_reg_475 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal icmp_ln887_22_fu_222_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_V_23_fu_265_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_V_23_reg_493 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal icmp_ln887_23_fu_259_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal d_V_6_addr_reg_503 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal icmp_ln887_24_fu_292_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln544_75_fu_244_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln321_6_fu_254_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln544_76_fu_271_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln544_77_fu_323_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal add_ln321_5_fu_249_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal trunc_ln1352_fu_276_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal ret_V_105_fu_280_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln215_8_fu_308_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln1353_4_fu_312_p2 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln887_23_fu_259_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state6))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_fu_194_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                ...
                p_0281_1_reg_161 <= i_V_22_reg_475;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_22_fu_222_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                p_0281_2_reg_172 <= ap_const_lv4_0;
            elsif (((icmp_ln887_24_fu_292_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
                p_0281_2_reg_172 <= i_V_23_reg_493;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_23_fu_259_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state6))) then
                d_V_6_addr_reg_503 <= zext_ln544_76_fu_271_p1(3 - 1 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                i_V_22_reg_475 <= i_V_22_fu_228_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state6)) then
                i_V_23_reg_493 <= i_V_23_fu_265_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_24_fu_292_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state7))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_22_fu_222_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln887_fu_194_p2, ap_CS_fsm_state4, icmp_ln887_22_fu_222_p2, ap_CS_fsm_state6, icmp_ln887_23_fu_259_p2, ap_CS_fsm_state7, icmp_ln887_24_fu_292_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state6 => 
                if (((icmp_ln887_23_fu_259_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state6))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state7;
                end if;
            when ap_ST_fsm_state7 => 
                if (((icmp_ln887_24_fu_292_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then
                    ap_NS_fsm <= ap_ST_fsm_state6;
                else
    ...
    add_ln1353_4_fu_312_p2 <= std_logic_vector(signed(ap_const_lv13_1141) + signed(zext_ln215_8_fu_308_p1));
    add_ln1353_fu_318_p2 <= std_logic_vector(unsigned(add_ln1353_4_fu_312_p2) + unsigned(zext_ln414_reg_498));
    add_ln321_5_fu_249_p2 <= std_logic_vector(unsigned(zext_ln215_reg_480) + unsigned(ap_const_lv13_8B1));
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state6, icmp_ln887_23_fu_259_p2)
    begin
        if ((((icmp_ln887_23_fu_259_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state6)) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state6, icmp_ln887_23_fu_259_p2)
    begin
        if (((icmp_ln887_23_fu_259_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state6))) then 
    ...
    ct_V_address0_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state4, ap_CS_fsm_state7, zext_ln544_fu_206_p1, zext_ln544_75_fu_244_p1, zext_ln544_77_fu_323_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
            ct_V_address0 <= zext_ln544_77_fu_323_p1(13 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            ct_V_address0 <= zext_ln544_75_fu_244_p1(13 - 1 downto 0);
    ...
    d_V_6_address0 <= d_V_6_addr_reg_503;

    d_V_6_ce0_assign_proc : process(ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    d_V_6_d0 <= (select_ln414_3_fu_417_p3 and and_ln414_fu_436_p2);

    d_V_6_we0_assign_proc : process(ap_CS_fsm_state9, shl_ln414_2_fu_452_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
            d_V_6_we0 <= shl_ln414_2_fu_452_p2;
        else 
            d_V_6_we0 <= ap_const_lv8_0;
        end if; 
    end process;

    i_V_22_fu_228_p2 <= std_logic_vector(unsigned(p_0281_1_reg_161) + unsigned(ap_const_lv12_1));
    i_V_23_fu_265_p2 <= std_logic_vector(unsigned(p_0281_2_reg_172) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln887_22_fu_222_p2 <= "1" when (p_0281_1_reg_161 = ap_const_lv12_8A0) else "0";
    icmp_ln887_23_fu_259_p2 <= "1" when (p_0281_2_reg_172 = ap_const_lv4_8) else "0";
    icmp_ln887_24_fu_292_p2 <= "1" when (p_0180_0_reg_183 = ap_const_lv4_8) else "0";
    ...
    ret_V_105_fu_280_p3 <= (trunc_ln1352_fu_276_p1 & ap_const_lv3_0);
    ...
    select_ln414_3_fu_417_p3 <= 
        tmp_6_fu_407_p4 when (icmp_ln414_reg_542(0) = '1') else 
        shl_ln414_fu_401_p2;
    ...
    tmp_6_fu_407_p4_proc : process(shl_ln414_fu_401_p2)
    ...
    variable tmp_6_fu_407_p4_i : integer;
    ...
    begin
        ...
        if (vlo_cpy(6 - 1 downto 0) > vhi_cpy(6 - 1 downto 0)) then
            ...
            for tmp_6_fu_407_p4_i in 0 to 64-1 loop
                v0_cpy(tmp_6_fu_407_p4_i) := shl_ln414_fu_401_p2(64-1-tmp_6_fu_407_p4_i);
            end loop;
        end if;
        ...
        tmp_6_fu_407_p4 <= resvalue(64-1 downto 0);
    end process;
    ...
    u_V_address1_assign_proc : process(ap_CS_fsm_state3, ap_CS_fsm_state5, zext_ln321_fu_217_p1, zext_ln321_6_fu_254_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
            u_V_address1 <= zext_ln321_6_fu_254_p1(13 - 1 downto 0);
    ...
    zext_ln215_8_fu_308_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_0180_0_reg_183),13));
    zext_ln215_fu_234_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_0281_1_reg_161),13));
    zext_ln321_6_fu_254_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln321_5_fu_249_p2),64));
    ...
    zext_ln414_fu_288_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ret_V_105_fu_280_p3),13));
    zext_ln544_75_fu_244_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ret_V_fu_238_p2),64));
    zext_ln544_76_fu_271_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_0281_2_reg_172),64));
    zext_ln544_77_fu_323_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln1353_fu_318_p2),64));
