...
architecture behav of expand_and_sum is 
    ...
    signal ret_V_110_fu_172_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal ret_V_110_reg_288 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal store_A_V_addr_reg_306 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal icmp_ln887_26_fu_219_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln544_81_fu_240_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal offset_V_cast_fu_134_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal ret_V_109_fu_160_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln215_10_fu_168_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal trunc_ln1352_fu_189_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln215_11_fu_201_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal ret_V_111_fu_205_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal zext_ln215_12_fu_231_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal ret_V_112_fu_235_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_26_fu_219_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_26_fu_219_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                dst_V_addr_reg_324 <= zext_ln544_81_fu_240_p1(7 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_fu_142_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                ...
                ret_V_110_reg_288 <= ret_V_110_fu_172_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln124_fu_177_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                ...
                store_A_V_addr_reg_306 <= zext_ln544_fu_210_p1(12 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln887_fu_142_p2, ap_CS_fsm_state3, icmp_ln124_fu_177_p2, ap_CS_fsm_state4, icmp_ln887_26_fu_219_p2)
    begin
        case ap_CS_fsm is
    ...
    dst_V_address0 <= zext_ln544_81_fu_240_p1(7 - 1 downto 0);
    ...
    icmp_ln887_26_fu_219_p2 <= "1" when (t_V_5_reg_123 = ap_const_lv4_8) else "0";
    ...
    r_V_fu_245_p2 <= std_logic_vector(shift_right(unsigned(store_A_V_q0),to_integer(unsigned('0' & zext_ln887_reg_311(8-1 downto 0)))));
    ret_V_109_fu_160_p3 <= (p_0110_0_reg_101 & ap_const_lv4_0);
    ret_V_110_fu_172_p2 <= std_logic_vector(unsigned(zext_ln215_reg_270) + unsigned(zext_ln215_10_fu_168_p1));
    ret_V_111_fu_205_p2 <= std_logic_vector(unsigned(zext_ln215_11_fu_201_p1) + unsigned(ret_V_110_reg_288));
    ret_V_112_fu_235_p2 <= std_logic_vector(unsigned(ret_V_reg_301) + unsigned(zext_ln215_12_fu_231_p1));
    ret_V_fu_193_p3 <= (trunc_ln1352_fu_189_p1 & ap_const_lv3_0);
    store_A_V_address0 <= store_A_V_addr_reg_306;

    store_A_V_ce0_assign_proc : process(ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    zext_ln215_10_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ret_V_109_fu_160_p3),17));
    zext_ln215_11_fu_201_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_V_reg_112),17));
    zext_ln215_12_fu_231_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_V_5_reg_123),7));
    zext_ln215_fu_138_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(offset_V_cast_fu_134_p1),17));
    zext_ln544_81_fu_240_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ret_V_112_fu_235_p2),64));
    zext_ln544_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ret_V_111_fu_205_p2),64));
