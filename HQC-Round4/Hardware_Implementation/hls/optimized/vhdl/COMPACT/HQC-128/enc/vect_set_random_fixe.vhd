...
architecture behav of vect_set_random_fixe is 
    ...
    signal grp_KeccakF1600_StatePer_fu_467_state_V_6_address0 : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_KeccakF1600_StatePer_fu_467_state_V_6_ce0 : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_467_state_V_6_address1 : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_KeccakF1600_StatePer_fu_467_state_V_6_ce1 : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_467_state_V_6_we1 : STD_LOGIC;
    signal grp_KeccakF1600_StatePer_fu_467_state_V_6_d1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component vect_set_random_fmb6 IS
    generic (
        DataWidth : INTEGER;
...
begin
    rand_bytes_V_U : component vect_set_random_fmb6
    generic map (
        DataWidth => 8,
        AddressRange => 225,
        AddressWidth => 8)
    ...
    -- port map (
        ...
        -- state_V_6_address0 => grp_KeccakF1600_StatePer_fu_467_state_V_6_address0,
        -- state_V_6_ce0 => grp_KeccakF1600_StatePer_fu_467_state_V_6_ce0,
        -- state_V_6_q0 => state_seedexpander_V_q0,
        -- state_V_6_address1 => grp_KeccakF1600_StatePer_fu_467_state_V_6_address1,
        -- state_V_6_ce1 => grp_KeccakF1600_StatePer_fu_467_state_V_6_ce1,
        -- state_V_6_we1 => grp_KeccakF1600_StatePer_fu_467_state_V_6_we1,
        -- state_V_6_d1 => grp_KeccakF1600_StatePer_fu_467_state_V_6_d1);
  ...
  grp_KeccakF1600_StatePer_fu_467_state_V_6_address0 <= state_V_address0_permute;
  grp_KeccakF1600_StatePer_fu_467_state_V_6_ce0      <= state_V_ce0_permute;
  grp_KeccakF1600_StatePer_fu_467_state_V_6_address1 <= state_V_address1_permute;
  grp_KeccakF1600_StatePer_fu_467_state_V_6_ce1      <= state_V_ce1_permute;
  grp_KeccakF1600_StatePer_fu_467_state_V_6_we1      <= state_V_we1_permute;
  grp_KeccakF1600_StatePer_fu_467_state_V_6_d1       <= state_V_d1_permute;
  
    crypto_kem_enc_hlncg_U28 : component crypto_kem_enc_hlncg
    generic map (
        ID => 1,
        NUM_STAGE => 28,
        din0_WIDTH => 24,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_fu_487_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                p_072_0_reg_282 <= ap_const_lv8_E1;
    ...
    icmp_ln879_fu_518_p2 <= "1" when (p_072_1_reg_305 = ap_const_lv8_E1) else "0";
    icmp_ln887_1_fu_512_p2 <= "1" when (unsigned(t_V_1_fu_152) < unsigned(ap_const_lv8_4B)) else "0";
    icmp_ln887_2_fu_524_p2 <= "1" when (unsigned(p_0292_0_i_reg_327) < unsigned(ap_const_lv8_E1)) else "0";
    ...
    icmp_ln887_5_fu_659_p2 <= "1" when (unsigned(ret_V_fu_653_p2) < unsigned(ap_const_lv8_E1)) else "0";
    ...
    state_seedexpander_V_address0_assign_proc : process(ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state11, grp_KeccakF1600_StatePer_fu_467_state_V_6_address0, ap_CS_fsm_state10, zext_ln49_fu_545_p1, zext_ln65_fu_615_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            ...
            state_seedexpander_V_address0 <= grp_KeccakF1600_StatePer_fu_467_state_V_6_address0;
        else 
    ...
    state_seedexpander_V_address1_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state11, grp_KeccakF1600_StatePer_fu_467_state_V_6_address1, ap_CS_fsm_state10)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state11) or (ap_const_logic_1 = ap_CS_fsm_state8))) then 
            ...
            state_seedexpander_V_address1 <= grp_KeccakF1600_StatePer_fu_467_state_V_6_address1;
        else 
    ...
    state_seedexpander_V_ce0_assign_proc : process(ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state11, grp_KeccakF1600_StatePer_fu_467_state_V_6_ce0, ap_CS_fsm_state10)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state11) or (ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
            ...
            state_seedexpander_V_ce0 <= grp_KeccakF1600_StatePer_fu_467_state_V_6_ce0;
        else 
    ...
    state_seedexpander_V_ce1_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state11, grp_KeccakF1600_StatePer_fu_467_state_V_6_ce1, ap_CS_fsm_state10)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state11) or (ap_const_logic_1 = ap_CS_fsm_state8))) then 
            state_seedexpander_V_ce1 <= ap_const_logic_1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
            state_seedexpander_V_ce1 <= grp_KeccakF1600_StatePer_fu_467_state_V_6_ce1;
        else 
    ...
    state_seedexpander_V_d1_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state11, grp_KeccakF1600_StatePer_fu_467_state_V_6_d1, ap_CS_fsm_state10, sext_ln301_fu_582_p1, zext_ln214_fu_632_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            ...
            state_seedexpander_V_d1 <= grp_KeccakF1600_StatePer_fu_467_state_V_6_d1;
        else 
    ...
    state_seedexpander_V_we1_assign_proc : process(ap_CS_fsm_state8, ap_phi_mux_op2_assign_phi_fu_366_p4, icmp_ln44_fu_554_p2, ap_CS_fsm_state11, icmp_ln887_4_fu_597_p2, icmp_ln63_fu_609_p2, grp_KeccakF1600_StatePer_fu_467_state_V_6_we1, ap_CS_fsm_state10)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state11) and ((icmp_ln63_fu_609_p2 = ap_const_lv1_0) or (icmp_ln887_4_fu_597_p2 = ap_const_lv1_0))) or ((ap_const_logic_1 = ap_CS_fsm_state8) and ((ap_phi_mux_op2_assign_phi_fu_366_p4 = ap_const_lv1_1) or (icmp_ln44_fu_554_p2 = ap_const_lv1_0))))) then 
            ...
            state_seedexpander_V_we1 <= grp_KeccakF1600_StatePer_fu_467_state_V_6_we1;
        else 
