...
architecture behav of hqc_public_key_from_s is 
    ...
    signal zext_ln66_fu_129_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln66_1_fu_185_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln66_fu_123_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln63_fu_103_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                pk_V_addr_reg_202 <= zext_ln66_fu_129_p1(9 - 1 downto 0);
    ...
    add_ln66_fu_123_p2 <= std_logic_vector(unsigned(i_0_reg_81) + unsigned(ap_const_lv9_5));
    ...
    s_V_address1 <= zext_ln66_1_fu_185_p1(12 - 1 downto 0);
    ...
    zext_ln66_1_fu_185_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln65_reg_215),64));
    zext_ln66_fu_129_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln66_fu_123_p2),64));
end behav;
