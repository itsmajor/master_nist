...
//////////////////////////////////////////////////////////////////////////////////////       
    ...
    crypto_kem_keypair_KAT(pk, sk, seedkeypair);

        //print KAT result:

fprintf(fp_keypair, "***Input and output tuples number %d ************************* \n\n", i+1 );
fprintf(fp_keypair, "When the input value seed is as following:  \n"  );
fprintBstr(fp_keypair, "seed = ", seedkeypair, MATRIX_SEED_BYTES+NOISE_SEED_BYTES);
...
//////////////////////////////////////////////////////////////////////////////////
	...
	randombytes(seedenc, NOISE_SEED_BYTES);
        ...
        crypto_kem_enc_KAT(ct, ss, pk, seedenc);
...
fprintBstr(fp_enc, "seed = ", seedenc, NOISE_SEED_BYTES);
