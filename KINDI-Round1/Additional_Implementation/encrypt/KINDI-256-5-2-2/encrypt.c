...
int crypto_encrypt_keypair(unsigned char *pk, unsigned char *sk) {
	...
	pk_p.b = (poly_d*) memalign(32, KINDI_CPA_L * sizeof(poly_d));
	pk_p.seed = (uint8_t *) malloc(KINDI_CPA_SEEDSIZE);
	sk_p = (poly_d*) memalign(32, KINDI_CPA_L * sizeof(poly_d));
...
int crypto_encrypt_open(unsigned char *m, unsigned long long *mlen,
	...
	pk_p.b = (poly_d*) memalign(32, KINDI_CPA_L * sizeof(poly_d));
	pk_p.seed = (uint8_t *) malloc(KINDI_CPA_SEEDSIZE);
	poly_d *sk_p = (poly_d*) memalign(32, KINDI_CPA_L * sizeof(poly_d));
