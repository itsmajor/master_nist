...
leaveBaseDir=../../..
testDir=../testresult/KINDI-512-3-2-1/kem
name=kem/KINDI-512-3-2-1;
...
mv PQCkemKAT.req $leaveBaseDir$testDir
mv PQCkemKAT.req $leaveBaseDir$testDir
mv PQCkemKAT*.rsp $leaveBaseDir$testDir
mv massif.* $leaveBaseDir$testDir/ 2> /dev/null
cd $leaveBaseDir
