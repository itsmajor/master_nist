...
echo "moved to: ${PWD}"
make
cp genkat ../../../../tests/AI_Asm/BabyBear
cd ../../../..

cd Additional_Implementations/Low_Memory/crypto_kem/BabyBearEphem
echo "moved to: ${PWD}"
make
cp genkat ../../../../tests/AI_Asm/BabyBearEphem
cd ../../../..

cd Additional_Implementations/Low_Memory/crypto_kem/MamaBear
echo "moved to: ${PWD}"
make
cp genkat ../../../../tests/AI_Asm/MamaBear
cd ../../../..

cd Additional_Implementations/Low_Memory/crypto_kem/MamaBearEphem
echo "moved to: ${PWD}"
make
cp genkat ../../../../tests/AI_Asm/MamaBearEphem
cd ../../../..

cd Additional_Implementations/Low_Memory/crypto_kem/PapaBear
echo "moved to: ${PWD}"
make
cp genkat ../../../../tests/AI_Asm/PapaBear
cd ../../../..

cd Additional_Implementations/Low_Memory/crypto_kem/PapaBearEphem
echo "moved to: ${PWD}"
make
cp genkat ../../../../tests/AI_Asm/PapaBearEphem
cd ../../../..