...
cmake -DCMAKE_BUILD_TYPE=Release -DLEVEL=1 -DRDTSC=1 -DUSE_AES_AND_SHA2=1 ..
make $MAKEOPTION
mv bike-test ../tests2/bike-test-1_aes
rm -R *

echo "cmake bike level 3 AES/SHA2 (10 repeats)"
cmake -DCMAKE_BUILD_TYPE=Release -DLEVEL=3 -DRDTSC=1 -DUSE_AES_AND_SHA2=1 ..
make $MAKEOPTION
mv bike-test ../tests2/bike-test-3_aes
rm -R *

echo "cmake bike level 5 AES/SHA2 (10 repeats)"
cmake -DCMAKE_BUILD_TYPE=Release -DLEVEL=5 -DRDTSC=1 -DUSE_AES_AND_SHA2=1 ..
make $MAKEOPTION
